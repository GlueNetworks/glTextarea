...
angular.module("glTextarea", [ "glSuperScroll" ]), angular.module("glTextarea").directive("glTextarea", [ "$compile", function(a) {
    ...
    return {
        ...
        link: function(b, c) {
            var d, e, f, g, h, i = b.$new(), j = "gl-empty", k = "gl-invalid", l = "gl-focus", m = "gl-disabled", n = '<div class="gl-textarea-container"></div>', o = '<textarea class="gl-textarea-input" data-gl-super-scroll data-ng-attr-placeholder="{{api._data.placeholder}}" data-ng-model="api._data.value"></textarea>', p = '<p class="gl-textarea-error">{{api._data.error}}</p>', q = '<label class="gl-textarea-view-label">{{api._data.label}}</label>', r = '<p class="gl-textarea-view-value">{{api._data.value}}</p>';
            d = angular.element(n), b.api = angular.isUndefined(b.api) ? {} : b.api, b.settings = angular.isUndefined(b.settings) ? {} : b.settings, 
            ...
            b.api.view = function() {
                ...
                b.api._data.valid = !1, b.api._data.error = angular.isString(a) ? a : void 0, w();
            }, b.api.setValid = function() {
                b.api._data.valid = !0, w();
                ...
                b.api._data.disabled = !0, e.attr("disabled", !0), d.addClass(m);
            }, b.api.enable = function() {
                b.api._data.disabled = !1, e.removeAttr("disabled"), d.removeClass(m);
            };
            var s = function() {
                //elementTextarea[0].rows = scope.api._data.rows;
                // event bindings
                return e = angular.element(o), e.attr("type", b.api._data.type), e.val(b.api._data.value), 
                b.api._data.disabled && (e.attr("disabled", !0), d.addClass(m)), angular.isUndefined(b.api._data.rows) || e.attr("rows", b.api._data.rows), 
                angular.isUndefined(b.api._data.cols) || e.attr("cols", b.api._data.cols), angular.isString(b.api._data.value) && "" != b.api._data.value ? e.removeClass(j) : e.addClass(j), 
            ...
            var t = function() {
                b.api._data.editable = !1, c.children().remove(), angular.isString(b.api._data.label) && (g = a(angular.element(q))(b), 
                c.append(g)), h = a(angular.element(r))(b), c.append(h);
            }, u = function() {
                i.$destroy(), c.children().remove(), i = b.$new(), d = angular.element(n), b.api._data.editable = !0, 
                d.append(s()), c.append(a(d)(i)), w(), v();
            }, v = function() {
                angular.isUndefined(e) || (!angular.isUndefined(b.api._data.value) && b.api._data.value.length > 0 ? (e.removeClass(j), 
                d.removeClass(j)) : (e.addClass(j), d.addClass(j)));
            }, w = function() {
                angular.isUndefined(f) || f.remove(), b.api._data.editable && (b.api._data.valid ? (e.removeClass(k), 
                d.removeClass(k)) : (e.addClass(k), d.addClass(k), angular.isString(b.api._data.error) && (f = angular.element(p), 
                c.append(a(f)(b)))));
            };
            b.$on("$destroy", function() {
                angular.isUndefined(b.api._data.onKeyDown) || e.unbind("keydown"), angular.isUndefined(b.api._data.onKeyUp) || e.unbind("keyup"), 
                angular.isUndefined(b.api._data.onKeyPress) || e.unbind("keypress"), angular.isUndefined(b.api._data.onInput) || e.unbind("input"), 
                angular.isUndefined(b.api._data.onMouseOver) || e.unbind("mouseover"), angular.isUndefined(b.api._data.onMouseOut) || e.unbind("mouseout"), 
                angular.isUndefined(b.api._data.onMouseMove) || e.unbind("mousemove"), angular.isUndefined(b.api._data.onMouseDown) || e.unbind("mousedown"), 
                angular.isUndefined(b.api._data.onMouseUp) || e.unbind("mouseup");
            }), // INIT
            angular.isUndefined(b.settings.view) || 1 != b.settings.view ? u() : t();
        }
    };
} ]);
